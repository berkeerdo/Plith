...
/// That is why <c>LocationResolver.ShouldRetryWindowsLocation</c> retries after both outcomes:
/// a user who flips the toggle back on mid-session must recover without restarting Plith.
/// </summary>
