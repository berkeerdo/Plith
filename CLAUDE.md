...
| `docs/PERF-VERIFICATION.md` | What the app costs at rest, on a launch and on a notch open, where inside the launch that time goes, down to what the first XAML load is made of, and which of it has been fixed |
